...
class BeritaModeListAdapter(private val onClick: (Berita) -> Unit) :
    RecyclerView.Adapter<BeritaModeListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_berita_mode_list, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(holder) {
            ...
            binding.modeListBeritaTanggalTerbit.text =
